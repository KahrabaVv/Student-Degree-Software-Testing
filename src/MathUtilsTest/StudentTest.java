...
public class StudentTest {
    ...
    @Before
    public void setup(){
     st = new Student("null" , "1234567a" , 0 , 0 , 0 , 0);
    }
    ...
    public void testSetName() {
        ...
        assertEquals(1, student.setName("John Doe"));

        // Test invalid input
        assertEquals(0, student.setName("")); // empty name
        assertEquals(0, student.setName("  Jane")); // name starting with space
        assertEquals(0, student.setName("Jane123")); // name containing numbers
        assertEquals(0, student.setName("Jane@Doe")); // name containing special characters
    }
    ...
    public void testSetNumber() {
        // Test valid input
        Student student = new Student("", "", 0, 0, 0, 0);
        assertEquals(0, student.setNumber("12345678s"));

        // Test invalid input
        assertEquals(0, student.setNumber("")); // empty number
        assertEquals(0, student.setNumber("12345678 ")); // number ending with space
        assertEquals(0, student.setNumber("12ABC678")); // number containing alphabetic characters
        assertEquals(0, student.setNumber("1234567@")); // number containing special characters
    }

    @Test
    public void testSetActivitiesMark() {
        // Test valid input
        Student student = new Student("", "", 0, 0, 0, 0);
        assertEquals(1, student.setActivitiesMark(5)); // within range

        // Test invalid input
        assertEquals(0, student.setActivitiesMark(-1)); // less than 0
        assertEquals(0, student.setActivitiesMark(11)); // greater than 10
    }

    @Test
    public void testSetPracticalMark() {
        // Test valid input
        Student student = new Student("", "", 0, 0, 0, 0);
        assertEquals(1, student.setPracticalMark(8)); // within range

        // Test invalid input
        assertEquals(0, student.setPracticalMark(-1)); // less than 0
        assertEquals(0, student.setPracticalMark(11)); // greater than 10
    }

    @Test
    public void testSetMidtermExamMark() {
        // Test valid input
        Student student = new Student("", "", 0, 0, 0, 0);
        assertEquals(1, student.setMidtermExamMark(15)); // within range

        // Test invalid input
        assertEquals(0, student.setMidtermExamMark(-1)); // less than 0
        assertEquals(0, student.setMidtermExamMark(21)); // greater than 20
    }

    @Test
    public void testSetFinalExamMark() {
        // Test valid input
        Student student = new Student("", "", 0, 0, 0, 0);
        assertEquals(1, student.setFinalExamMark(50)); // within range

        // Test invalid input
        assertEquals(0, student.setFinalExamMark(-1)); // less than 0
        assertEquals(0, student.setFinalExamMark(61)); // greater than 60
    }
}